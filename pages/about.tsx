  ...
  return (
    <>
      ...
      <main className={"main"}>
        ...
        <p>Our demonstration addresses these challenges by using blockchain technology to create a transparent and immutable record of ownership, licensing, and royalty payments. By leveraging the power of blockchain, we can create a tamper-proof record of every transaction, ensuring that creators can always prove ownership, buyers can verify authenticity, and royalties can be tracked and paid accurately.</p>
